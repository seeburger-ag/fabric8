...
public class ProtobufSerializationStrategy implements SerializationStrategy {
	...
	@Override
	public void encodeRequest(ClassLoader loader, Class<?>[] types,
			Object[] args, DataByteArrayOutputStream target) throws Exception {
		// TODO Auto-generated method stub
		
	}

	@Override
	public void decodeResponse(ClassLoader loader, Class<?> type,
			DataByteArrayInputStream source, AsyncCallback result)
			throws Exception {
		// TODO Auto-generated method stub
	...
	@Override
	public void decodeRequest(ClassLoader loader, Class<?>[] types,
			DataByteArrayInputStream source, Object[] target) throws Exception {
		// TODO Auto-generated method stub
		
	}

	@Override
	public void encodeResponse(ClassLoader loader, Class<?> type, Object value,
			Throwable error, DataByteArrayOutputStream target) throws Exception {
		// TODO Auto-generated method stub
