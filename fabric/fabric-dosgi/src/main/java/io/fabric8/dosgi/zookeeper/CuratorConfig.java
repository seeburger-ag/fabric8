...
import static io.fabric8.dosgi.zookeeper.Constants.DEFAULT_CONNECTION_TIMEOUT_MS;
import static io.fabric8.dosgi.zookeeper.Constants.DEFAULT_RETRY_INTERVAL;
import static io.fabric8.dosgi.zookeeper.Constants.DEFAULT_SESSION_TIMEOUT_MS;
import static io.fabric8.dosgi.zookeeper.Constants.MAX_RETRIES_LIMIT;
...
public class CuratorConfig {
    ...
    public CuratorConfig(Map configuration)
    {
        zookeeperPassword = (String)configuration.getOrDefault(Constants.ZOOKEEPER_PASSWORD, System.getProperty(Constants.ZOOKEEPER_PASSWORD, null));
        zookeeperUrl = (String)configuration.getOrDefault(Constants.ZOOKEEPER_URL, System.getProperty(Constants.ZOOKEEPER_URL, "localhost"));
